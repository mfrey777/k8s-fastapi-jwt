...
// Redux actionds
import { createFromExcelStart } from '../../redux/admin/admin.slice';
const layout = {
  labelCol: { span: 8 },
  wrapperCol: { span: 16 },
};
...
const CreateFromXmlPage = (): JSX.Element => {
  ...
  return (
    <div>
      <h1>Create structures and load master data from Excel file</h1>
      <Form
      ...
      >
        <Form.Item
          name="file_structure"
          label="Structure and Master Data Excel File (zip)"
...
export default CreateFromXmlPage;
