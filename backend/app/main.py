...
app.include_router(test_redis.router, prefix="/api/test/redis")
app.include_router(test_db.router, prefix="/api/test/db")
app.include_router(test_auth.router, prefix="/api/test/auth")
